...
import net.leon.myfypproject2.Classes.ImageCommentClass;
...
public class ImageComment extends AppCompatActivity {
    ...
    private DatabaseReference userRef,commeRef,ImagePostRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImagePostRef = FirebaseDatabase.getInstance().getReference().child("Post").child("Image_Posts").child(currentUserID).child(postKey).child("Comments");
        ...
        commentviewlist.setHasFixedSize(true);
