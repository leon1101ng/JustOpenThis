...
import net.leon.myfypproject2.Classes.FindFriendClass;
...
public class FindUserActivity extends AppCompatActivity {
    ...
    private void SearchOtherUser(String inputUsername) {
        ...
        FirebaseRecyclerAdapter<FindFriendClass, FindUserActivity.FindUserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FindFriendClass, FindUserActivity.FindUserViewHolder>(
                FindFriendClass.class,
                R.layout.user_friend_layout,
                FindUserActivity.FindUserViewHolder.class,
                searchuserquery
        ) {
            @Override
            protected void populateViewHolder(FindUserViewHolder viewHolder, FindFriendClass model, int position) {
