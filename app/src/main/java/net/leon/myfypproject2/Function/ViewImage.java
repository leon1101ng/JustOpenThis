...
import net.leon.myfypproject2.Classes.UserPostsImage;
...
public class ViewImage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        UserPostedImgRef = FirebaseDatabase.getInstance().getReference().child("Post").child("Image_Posts").child(current_UserID);
    ...
    public static class PostedImageHolder extends RecyclerView.ViewHolder{
        ...
        public void setpostimage(Context ctx, String Postimg){
            ...
            PhotoViewAttacher photoViewAttacher = new PhotoViewAttacher(postedimg);
